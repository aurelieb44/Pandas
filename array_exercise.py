...
integers2 = np.arange(0,111,10).reshape(3,4)
print(integers2)
print() 
...
integers3 = np.arange(0,111,10).reshape(4,3)
print(integers3)
...
worked = integers*integers3
print(worked)

## this worked! why? # same number of rows and columns
print()
